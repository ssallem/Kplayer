...
공개 웹은 누구나 사용할 수 있습니다. PC에서만 볼 때는 설치나 파일 전송이 필요 없습니다. PC 파일을 TV로 보내려면 **v1.2.0 이상 PC 연결 프로그램**을 실행하세요. 영상·자막 선택, TV 선택, 재생/일시정지, +10초 이동, 1% 음량, 자막 켜기/끄기를 공개 웹에서 제어할 수 있습니다. 선택한 영상과 자막은 내 PC에만 임시 복사하며 외부 서버로 업로드하지 않습니다.
